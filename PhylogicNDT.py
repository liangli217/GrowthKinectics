...
def build_parser():
    ...
    growthkinetics.add_argument('--wbc_time_file', '-wbc',
                                type=str,
                                dest='wbc_time_file',
                                help='WBC information tsv file with wbc at sample points and in between sample points')
    ...
    # Provide wbc and time information in a file rather than as command line inputs
